...
from additional_functions.metrics_missing_labels import get_metric
...
def get_loss(loss_name, reduction_mode="mean", custom_loss_name=None, **kwargs):
    if loss_name == "missing_labels_dice_loss":
        loss = missing_labels_dice_loss

    elif loss_name == "leaf_dice_loss":
        loss = leaf_dice_loss
